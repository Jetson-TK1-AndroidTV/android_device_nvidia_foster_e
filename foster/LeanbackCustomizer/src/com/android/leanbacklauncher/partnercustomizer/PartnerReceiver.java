...
public class PartnerReceiver extends BroadcastReceiver {
    ...
    private static final String TEGRA_PKG_NAME = "com.nvidia.tegrazone3";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (Intent.ACTION_PACKAGE_ADDED.equals(action)||
            ...
            postNotification(TEGRA_PKG_NAME);
    ...
    private void postNotification(String pkgName) {
        ...
        switch (pkgName) {
            case TEGRA_PKG_NAME:
                sort = 1;
                resId = R.drawable.ic_tegra_banner;
                backupResId = R.drawable.ic_tegra_banner;
                titleId = R.string.tegra;
                backupTitleId = R.string.try_tegra;
                break;
